package com.eventapp.eventservice.exceptions;

import com.eventapp.eventservice.exceptions.domain.EventNotFoundException;
import io.grpc.Status;
import lombok.extern.slf4j.Slf4j;import net.devh.boot.grpc.server.advice.GrpcAdvice;
...
public class GlobalGrpcExceptionHandler {
    ...
    public Status handleEventNotFound(EventNotFoundException e) {
    ...
    public Status handleAccessDenied(AccessDeniedException e) {
        ...
        return Status.PERMISSION_DENIED
              .withDescription("You do not have permission to access this event.");
    }
